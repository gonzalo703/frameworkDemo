...
public class SubmitOrderTestDraft {
    public static void main(String[] args) {
        ...
        WebElement desiredProduct = products.stream().filter(product -> product
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".np-animating")));
        ...
        a.sendKeys(driver.findElement(By.cssSelector("[placeholder='Select Country']")), "argentina").build().perform();
